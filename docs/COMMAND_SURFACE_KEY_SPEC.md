...
- **Position**: Pan, PanFine, Tilt, TiltFine, **Speed** ("movement speed" — Speed used to classify as `Other` under the old 4-value `AttributeClass`; it now matches the Encoder Drawer's pre-existing `EncoderCategory` treatment)
